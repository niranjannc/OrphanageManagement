...
<meta charset = "UTF-8" />
<meta name = "description" content = "Change Password for Head" />
	...
	<form method = "POST" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
		...
		<fieldset style = "width : 30%">
			...
			<div align = "left">
				...
				<input type = "text" id = "username" name = "username" placeholder = "Username" value = "<?php echo $uname; ?>" disabled /><br /><br />
